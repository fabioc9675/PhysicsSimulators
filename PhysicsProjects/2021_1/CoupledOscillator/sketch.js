...
let caja = function(_x,_y,_w,_color){
  ...
  this.movimiento1 = function(_amp1,_amp2,_k1,_k2,_k3,_m1,_m2,_fas1,_fas2){
    ...
    this.b=((this.k1+this.k2)/this.m1-(this.k2+this.k3)/this.m2)**2;
    ...
    this.x = this.x + this.amp1*sin(this.omega1*dt+this.fas1)+this.amp2*sin(this.omega2*dt+this.fas2);
    
    
  };

  this.movimiento2 = function(_amp1,_amp2,_k1,_k2,_k3,_m1,_m2,_fas1,_fas2){
    ...
    this.x = this.x + this.amp1*sin(this.omega3*dt+this.fas1)-this.amp2*sin(this.omega4*dt+this.fas2);
