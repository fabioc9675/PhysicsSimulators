 ...
 * ***********************************************************
 * * Autores: Carlos Andres Toro                             *
 * *          Lucas Hernan Quiceno                           *
...
let buttonName = "Iniciar"; // nombre del boton
let simular = false; // bandera para iniciar o parar simulacion
let colores = []; // vector de colores
let mostrarTrayec = false; // bandera para mostrar trayectoria
...
function setup() {
  ...
  colores.push([255, 233, 0]);
  colores.push([255, 0, 0]);
  colores.push([0, 0, 255]);
  colores.push([87, 35, 100]);
  colores.push([255, 128, 0]);
  colores.push([255, 177, 187]);
  ...
  button.position(0.92 * w, h + 10);
  button.size(70, 20);

  button2 = createButton(buttonName);
  button2.mousePressed(Seguir);
  button2.position(0.92 * w, h + 35);
  button2.size(70, 20);

  button3 = createButton("Trayectoria");
  button3.mousePressed(mostrarTrayectoria);
  button3.position(0.92 * w, h + 60);
  button3.size(70, 20);

  button4 = createButton("Guardar");
  button4.mousePressed(Salvar);
  button4.position(0.92 * w, h + 85);
  button4.size(70, 20);
  ...
  sliderR1 = createSlider(10, 200, 50, 1); //crea slider que puede variar entre 10 y 200, tomando por defecto el valor 10 y variando en pasos de una unidad.
  sliderR1.position(0.07 * w, h + l - 121); //posiciona slider
  sliderR1.size(0.08 * w, 12);
  ...
  p21.position(0.16 * w, h + l - 136); // posiciona dicho valor numerico.

  p12 = createP("Roja");
  p12.position(0, h + 13 + 20);
  sliderR2 = createSlider(10, 200, 50, 1);
  sliderR2.position(0.07 * w, h + l - 101);
  sliderR2.size(0.08 * w, 12);
  p22 = createP(sliderR2.value());
  p22.position(0.16 * w, h + l - 116);

  p13 = createP("Azul");
  p13.position(0, h + 13 + 40);
  sliderR3 = createSlider(10, 200, 100, 1);
  sliderR3.position(0.07 * w, h + l - 81);
  sliderR3.size(0.08 * w, 12);
  p23 = createP(sliderR1.value());
  p23.position(0.16 * w, h + l - 96);

  p14 = createP("Morada");
  p14.position(0, h + 13 + 60);
  sliderR4 = createSlider(10, 200, 100, 1);
  sliderR4.position(0.07 * w, h + l - 61);
  sliderR4.size(0.08 * w, 12);
  p24 = createP("R=" + sliderR1.value());
  p24.position(0.16 * w, h + l - 76);

  p15 = createP("Naranja");
  p15.position(0, h + 13 + 80);
  sliderR5 = createSlider(10, 200, 150, 1);
  sliderR5.position(0.07 * w, h + l - 41);
  sliderR5.size(0.08 * w, 12);
  p25 = createP(sliderR1.value());
  p25.position(0.16 * w, h + l - 56);

  p16 = createP("Rosada");
  p16.position(0, h + 13 + 100);
  sliderR6 = createSlider(10, 200, 150, 1);
  sliderR6.position(0.07 * w, h + l - 21);
  sliderR6.size(0.08 * w, 12);
  p26 = createP(sliderR1.value());
  p26.position(0.16 * w, h + l - 36);
  ...
  p_x.position(0.2 * w, h - 5);

  sliderpx1 = createSlider(
    round(-w / 2 + 2 * 12, 1),
    round(w / 2 - 2 * 12, 1),
    -w / 2 + (2 * w) / 7,
    0.1
  );
  sliderpx1.position(0.2 * w, h + l - 121);
  sliderpx1.size(0.07 * w, 12);
  px1 = createP(sliderpx1.value());
  px1.position(0.28 * w, h + l - 136);

  sliderpx2 = createSlider(
    round(-w / 2 + 2 * 12, 1),
    round(w / 2 - 2 * 12, 1),
    -w / 2 + (5 * w) / 7,
    0.1
  );
  sliderpx2.position(0.2 * w, h + l - 101);
  sliderpx2.size(0.07 * w, 12);
  px2 = createP(sliderpx2.value());
  px2.position(0.28 * w, h + l - 116);

  sliderpx3 = createSlider(
    round(-w / 2 + 2 * 12, 1),
    round(w / 2 - 2 * 12, 1),
    -w / 2 + (1 * w) / 7,
    0.1
  );
  sliderpx3.position(0.2 * w, h + l - 81);
  sliderpx3.size(0.07 * w, 12);
  px3 = createP(sliderpx3.value());
  px3.position(0.28 * w, h + l - 96);

  sliderpx4 = createSlider(
    round(-w / 2 + 2 * 12, 1),
    round(w / 2 - 2 * 12, 1),
    -w / 2 + (4 * w) / 7,
    0.1
  );
  sliderpx4.position(0.2 * w, h + l - 61);
  sliderpx4.size(0.07 * w, 12);
  px4 = createP("R=" + sliderpx4.value());
  px4.position(0.28 * w, h + l - 76);

  sliderpx5 = createSlider(
    round(-w / 2 + 2 * 12, 1),
    round(w / 2 - 2 * 12, 1),
    -w / 2 + (3 * w) / 7,
    0.1
  );
  sliderpx5.position(0.2 * w, h + l - 41);
  sliderpx5.size(0.07 * w, 12);
  px5 = createP("R=" + sliderpx5.value());
  px5.position(0.28 * w, h + l - 56);

  sliderpx6 = createSlider(
    round(-w / 2 + 2 * 12, 1),
    round(w / 2 - 2 * 12, 1),
    -w / 2 + (6 * w) / 7,
    0.1
  );
  sliderpx6.position(0.2 * w, h + l - 21);
  sliderpx6.size(0.07 * w, 12);
  px6 = createP("R=" + sliderpx6.value());
  px6.position(0.28 * w, h + l - 36);

  //sliders posicion y
  p_y = createP("Posición y [cm]");
  p_y.position(0.33 * w, h - 5);

  sliderpy1 = createSlider(
    round(-h / 2 + 2 * 12, 1),
    round(h / 2 - 2 * 12, 1),
    0,
    0.1
  );
  sliderpy1.position(0.33 * w, h + l - 121);
  sliderpy1.size(0.07 * w, 12);
  py1 = createP(sliderpy1.value());
  py1.position(0.41 * w, h + l - 136);

  sliderpy2 = createSlider(
    round(-h / 2 + 2 * 12, 1),
    round(h / 2 - 2 * 12, 1),
    0,
    0.1
  );
  sliderpy2.position(0.33 * w, h + l - 101);
  sliderpy2.size(0.07 * w, 12);
  py2 = createP("R=" + sliderpy2.value());
  py2.position(0.41 * w, h + l - 116);

  sliderpy3 = createSlider(
    round(-h / 2 + 2 * 12, 1),
    round(h / 2 - 2 * 12, 1),
    0,
    0.1
  );
  sliderpy3.position(0.33 * w, h + l - 81);
  sliderpy3.size(0.07 * w, 12);
  py3 = createP("R=" + sliderpy3.value());
  py3.position(0.41 * w, h + l - 96);

  sliderpy4 = createSlider(
    round(-h / 2 + 2 * 12, 1),
    round(h / 2 - 2 * 12, 1),
    0,
    0.1
  );
  sliderpy4.position(0.33 * w, h + l - 61);
  sliderpy4.size(0.07 * w, 12);
  py4 = createP("R=" + sliderpy4.value());
  py4.position(0.41 * w, h + l - 76);

  sliderpy5 = createSlider(
    round(-h / 2 + 2 * 12, 1),
    round(h / 2 - 2 * 12, 1),
    0,
    0.1
  );
  sliderpy5.position(0.33 * w, h + l - 41);
  sliderpy5.size(0.07 * w, 12);
  py5 = createP("R=" + sliderpy5.value());
  py5.position(0.41 * w, h + l - 56);

  sliderpy6 = createSlider(
    round(-h / 2 + 2 * 12, 1),
    round(h / 2 - 2 * 12, 1),
    0,
    0.1
  );
  sliderpy6.position(0.33 * w, h + l - 21);
  sliderpy6.size(0.07 * w, 12);
  py6 = createP(sliderpy6.value());
  py6.position(0.41 * w, h + l - 36);

  //sliders velocidad x
  v_x = createP("Velocidad x [cm/s]");
  v_x.position(0.46 * w, h - 5);

  slidervx1 = createSlider(-30, 30, 10, 0.1);
  slidervx1.position(0.46 * w, h + l - 121);
  slidervx1.size(0.09 * w, 12);
  vx1 = createP(slidervx1.value());
  vx1.position(0.56 * w, h + l - 136);

  slidervx2 = createSlider(-30, 30, -10, 0.1);
  slidervx2.position(0.46 * w, h + l - 101);
  slidervx2.size(0.09 * w, 12);
  vx2 = createP(slidervx2.value());
  vx2.position(0.56 * w, h + l - 116);

  slidervx3 = createSlider(-30, 30, 0, 0.1);
  slidervx3.position(0.46 * w, h + l - 81);
  slidervx3.size(0.09 * w, 12);
  vx3 = createP(slidervx3.value());
  vx3.position(0.56 * w, h + l - 96);

  slidervx4 = createSlider(-30, 30, 0, 0.1);
  slidervx4.position(0.46 * w, h + l - 61);
  slidervx4.size(0.09 * w, 12);
  vx4 = createP(slidervx4.value());
  vx4.position(0.56 * w, h + l - 76);

  slidervx5 = createSlider(-30, 30, 0, 0.1);
  slidervx5.position(0.46 * w, h + l - 41);
  slidervx5.size(0.09 * w, 12);
  vx5 = createP(slidervx5.value());
  vx5.position(0.56 * w, h + l - 56);

  slidervx6 = createSlider(-30, 30, 0, 0.1);
  slidervx6.position(0.46 * w, h + l - 21);
  slidervx6.size(0.09 * w, 12);
  vx6 = createP(slidervx6.value());
  vx6.position(0.56 * w, h + l - 36);

  //sliders velocidad y
  v_y = createP("Velocidad y [cm/s]");
  v_y.position(0.61 * w, h - 5);

  slidervy1 = createSlider(-30, 30, -5, 0.1);
  slidervy1.position(0.61 * w, h + l - 121);
  slidervy1.size(0.09 * w, 12);
  vy1 = createP(slidervy1.value());
  vy1.position(0.71 * w, h + l - 136);

  slidervy2 = createSlider(-30, 30, -5, 0.1);
  slidervy2.position(0.61 * w, h + l - 101);
  slidervy2.size(0.09 * w, 12);
  vy2 = createP(slidervy2.value());
  vy2.position(0.71 * w, h + l - 116);

  slidervy3 = createSlider(-30, 30, 0, 0.1);
  slidervy3.position(0.61 * w, h + l - 81);
  slidervy3.size(0.09 * w, 12);
  vy3 = createP(slidervy3.value());
  vy3.position(0.71 * w, h + l - 96);

  slidervy4 = createSlider(-30, 30, 0, 0.1);
  slidervy4.position(0.61 * w, h + l - 61);
  slidervy4.size(0.09 * w, 12);
  vy4 = createP(slidervy4.value());
  vy4.position(0.71 * w, h + l - 76);

  slidervy5 = createSlider(-30, 30, 0, 0.1);
  slidervy5.position(0.61 * w, h + l - 41);
  slidervy5.size(0.09 * w, 12);
  vy5 = createP(slidervy5.value());
  vy5.position(0.71 * w, h + l - 56);

  slidervy6 = createSlider(-30, 30, 0, 0.1);
  slidervy6.position(0.61 * w, h + l - 21);
  slidervy6.size(0.09 * w, 12);
  vy6 = createP(slidervy6.value());
  vy6.position(0.71 * w, h + l - 36);

  //barra de bolas
  sliderx = createSlider(1, 6, 2); //controla numero de bolas
  sliderx.position(0.75 * w, h + l - 125); //posiciona slider
  sliderx.size(0.1 * w, 12);
  p1 = createP("Número de bolas"); //crea etiqueta de Numero de bolas y muestra el valor numérico asignado por el usuario.
  p1.position(0.75 * w, h - 5); //posiciona la etiqueta anterior.
  NumeroBolas = createP(sliderx.value());
  NumeroBolas.position(0.86 * w, h + l - 140);
  //barra elasticidad. Sigue una estructura y comentarios analogos a la barra de bolas.
  slidery = createSlider(0.1, 100, 100, 0.1);
  slidery.position(0.75 * w, h + l - 80);
  slidery.size(0.1 * w, 12);
  p2 = createP("Porcentaje de elasticidad");
  p2.position(0.75 * w, h + 40);

  Elasticidad = createP(slidery.value());
  Elasticidad.position(0.86 * w, h + l - 95);

  //barra fricción. Sigue una estructura y comentarios analogos a la barra de bolas.
  sliderz = createSlider(0, 1, 0, 0.01);
  sliderz.position(0.75 * w, h + l - 35);
  sliderz.size(0.1 * w, 12);
  p3 = createP("Coeficiente de fricción ");
  p3.position(0.75 * w, h + 85);

  Friccion = createP(sliderz.value());
  Friccion.position(0.86 * w, h + l - 50);
...
function Salvar() {
  saveTable(table, "datos.html"); //funcion que permite guardar en una tabla los diferentes valores de las velocidades de las bolas de billar durante la simulación.
} // Se puede cambiar el formato de html por csv o tsv.

function mostrarvelocidades() {
  //esta funcion actualiza los valores numéricos de las etiquetas de las velocidades en los sliders y actualiza
  ...
  VY = [
    ...
    slidervy5.value(),
    slidervy6.value(),
  ]; //velocidades iniciales en y

  //for recorre numero de bolas
  if (simular == false) {
    for (let i = 0; i < N; i++) {
      balls[i].velActualizar(VX[i], VY[i]);
    }
  }
}
...
function resetSketch() {
  ...
  p = 0; // reinicia contador de tiempo
  ...
  for (let i = 0; i < N; i++) {
    balls.push(
      new ball(
        i,
        M[i],
        20 * ((3 * M[i]) / (12.56 * 6)) ** (1 / 3),
        createVector(PX[i], PY[i]),
        createVector(VX[i], VY[i]),
        colores[i]
      )
    );
    for (let j = 0; j < i; j++) {
...
function draw() {
  ...
  for (let i = 0; i < N; i++) {
    if (balls[i].vel.x == 0 && balls[i].vel.y == 0) {
      //condicion para bola en reposo (antes de iniciar simulación por ejemplo)
  ...
  if (simular == true) {
    ...
    if (f < p && p < f + 26) {
      //solo en este pequeño intervalo se toman los datos de las velocidades de las bolas, ya que si incrementamos el tiempo
      ...
      if (N == 1) {
        table
          .getRow(p - f - 1)
          .setNum("Velocidad en x Amarilla", balls[0].vel.x);
        table
          .getRow(p - f - 1)
          .setNum("Velocidad en y Amarilla", balls[0].vel.y);
        ...
        //Procedimento para guardar datos en el caso de dos bolas
        table
          .getRow(p - f - 1)
          .setNum("Velocidad en x Amarilla", balls[0].vel.x);
        table
        ...
        //Procedimento para guardar datos en el caso de tres bolas
        table
          .getRow(p - f - 1)
          .setNum("Velocidad en x Amarilla", balls[0].vel.x);
        table
        ...
        //Procedimento para guardar datos en el caso de cuatro bolas
        table
          .getRow(p - f - 1)
          .setNum("Velocidad en x Amarilla", balls[0].vel.x);
        table
        ...
        table
          .getRow(p - f - 1)
          .setNum("Velocidad en x Naranja", balls[4].vel.x);
        table
          .getRow(p - f - 1)
          .setNum("Velocidad en y Naranja", balls[4].vel.y);
        table.getRow(p - f - 1).setString("Velocidad en x Rosada", "Ninguna");
        table.getRow(p - f - 1).setString("Velocidad en y Rosada", "Ninguna");
      } else if (N == 6) {
        //Procedimento para guardar datos en el caso de seis bolas
        table
          .getRow(p - f - 1)
          .setNum("Velocidad en x Amarilla", balls[0].vel.x);
        table
...
let ball = function (i, _mass, _rad, _pos, _vel, _color) {
  this.mass = _mass;
  this.radio = _rad;
  this.pos = _pos;
  this.vel = _vel;
  ...
  this.mostrar = function () {
    ...
    if (mostrarTrayec == true) {
      // decide si muestra o no la trayectoria
  ...
  this.collision = function () {
    if (
      this.pos.x < -w / 2 + 10 + this.radio ||
      this.pos.x > w / 2 - 10 - this.radio
    ) {
      this.vel.x *= -1;
    }
    if (
      this.pos.y < -h / 2 + 10 + this.radio ||
      this.pos.y > h / 2 - 10 - this.radio
    ) {
      this.vel.y *= -1;
    }
  ...
  // funcion para actualizar velocidades
  this.velActualizar = function (vel_x, vel_y) {
    this.vel.x = vel_x;
    this.vel.y = vel_y;
  };
};
...
inelasticballscollision = function (object1, object2) {
  ...
  let u = createVector(
    (object1.pos.x - object2.pos.x) / d,
    (object1.pos.y - object2.pos.y) / d
  );
  let s = createVector(
    (object1.vel.x - object2.vel.x) /
      dist(object1.vel.x, object1.vel.y, object2.vel.x, object2.vel.y),
    (object1.vel.y - object2.vel.y) /
      dist(object1.vel.x, object1.vel.y, object2.vel.x, object2.vel.y)
  );
  ...
  let B =
    2 *
    ((object1.mass + object2.mass) / (object1.mass * object2.mass)) *
    ((object1.vel.x - object2.vel.x) * u.x +
      (object1.vel.y - object2.vel.y) * u.y);
  let C =
    (1 - sq(k)) *
    sq(dist(object1.vel.x, object1.vel.y, object2.vel.x, object2.vel.y));
  let D = sq(B) - 4 * A * C;
  if (D < 0) {
    object1.vel.x = 0;
    object1.vel.y = 0;
...
function Seguir() {
  ...
  simular = !simular; // cambia el estado de la simulacion entre play y pause
  ...
  button2.html(buttonName);
}

function mostrarTrayectoria() {
  mostrarTrayec = !mostrarTrayec;

  // Cambia el nombre del boton
  if (mostrarTrayec == true) {
    button3.html("Ocultar");
  } else {
    button3.html("Trayectoria");
  }
}
